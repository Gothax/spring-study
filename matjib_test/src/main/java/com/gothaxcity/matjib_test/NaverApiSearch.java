...
public class NaverApiSearch {
    ...
    public void search(String searchWord) {
        ...
        requestHeaders.put("X-Naver-Client-Id", CommonConstants.clientId);
        requestHeaders.put("X-Naver-Client-Secret", CommonConstants.clientSecret);
        ...
        for (JsonElement itemElement : itemsArray) {
            ...
            String prettyJson = gson.toJson(itemObject);
